    ...
    local function load_syntax()
        ...
        local function load_plugins()
            ...
            local plugins = {
                ...
                -- Indent Blankline
                IndentBlanklineChar = { fg = colors.float, style = "nocombine" },
                IblIndent = { fg = colors.float, style = "nocombine" },
                IblScope = { fg = colors.blue, style = "nocombine" },
                ...
                -- Pandoc
                pandocAtxHeader = { fg = colors.green, style = "bold" },
                pandocAtxStart = { fg = colors.green, style = "bold" },
                pandocHeaderAttr = { fg = colors.green, style = "bold" },
                pandocSetexHeader = { fg = colors.green, style = "bold" },
                pandocHeaderID = { fg = colors.green, style = "bold" },
